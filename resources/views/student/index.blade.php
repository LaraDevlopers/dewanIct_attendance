...
<div id="student_result" class="d-none">
    ...
    <div class="row" id="">
        ...
        <div class="parent col-md-8 mt-5" >
            {{--  <p>This is div</p>  --}}
                   ...
                   <div class="row" >
                        ...
                        <div class="col-md-7 mx-auto" style="border:2px solid black" >
                            ...
                            <div class="row mt-2" style="padding: 15px">
                               ...
                               <div class="col-md-7">
                                   : <span class="s_name" style="font-weight: 800"></span>
                               </div>
                            ...
                            <div class="col-md-7">
                                : <span class="f_name"  style="font-weight: 800"></span>
                            </div>
                            <div class="col-md-5">
                                MOTHER&#8217S NAME
                            </div>
                            <div class="col-md-7">
                                : <span class="m_name"  style="font-weight: 800"></span>
                            </div>
                            <div class="col-md-5">
                               DATE OF BIRTH
                            </div>
                            <div class="col-md-7">
                                : <span class="date_of_birth"  style="font-weight: 800"></span>
                            </div>
                            <div class="col-md-5">
                                ID NO.
                            </div>
                            <div class="col-md-7">
                                : <span class="roll_no" style="font-weight: 800></span">
                            </div>
                            <div class="col-md-5">
                            REG NO.
                            </div>
                            <div class="col-md-7">
                                : <span class="reg_no" style="font-weight: 800"></span>
                            </div>
                            <div class="col-md-5">
                            NAME OF COURSE
                            </div>
                            ...
                            <div class="col-md-7">
                                : <span class="course_duration"  style="font-weight: 800"></span>
                            </div>
                            <div class="col-md-5">
                               PASSING YEAR
                            </div>
                            <div class="col-md-7">
                                : <span class="passing_year"  style="font-weight: 800"></span>
                            </div>
                            <div class="col-md-5">
                               LETTER GRADE
                            </div>
...
<div class="row d-none" id="certificate" style="height: 1500px">
    {{--  <div class="col-md-"></div>  --}}
    <div class="parent col-md-11 mx-auto mt-5">
        <div  class="elder_child" style="padding: 10px;background-image: url({{asset('assets/img/certificateBg.png')}});">
            <div class="row">
                 <div class="col-md-12 text-center m-2">
                     <p > Govt. of the peoples  Republic Bagladesh TEchnical Education Board AFfiliated Institution</p>
                ...
                <div class="col-md-12" style="margin-top: 470PX">
                    <div class="row "  >
                        <div class="col-md-4" >
                            <h4 style="text-decoration:overline">DIRECTOR</h4>
                        </div>
